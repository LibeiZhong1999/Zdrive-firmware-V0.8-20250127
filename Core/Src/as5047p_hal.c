...
static SPI_HandleTypeDef * handlerSPI; // SPI handler that is to be used for next SPI transaction
static GPIO_TypeDef * gpioPort; // GPIO port pointer that is to be used for next SPI transaction
...
//  spiStatus = HAL_SPI_TransmitReceive_DMA(handlerSPI, (uint8_t *)pTx, (uint8_t *)pRx, 1);
  ...
  switch (id)
   {
     ...
     //case 1:
       //gpioPort = SPI4_AS5047P_B_CS_GPIO_Port;
       //gpioPin = SPI4_AS5047P_B_CS_Pin;
       //handlerSPI = &hspi4;
       //break;
